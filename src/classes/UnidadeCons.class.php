<?php 
	...
	Class UnidadeConsumidora extends Unidade{
		...
		private $tipo;		// 0 = Água; 1 e 2 = Energia BT e AT m³ KWh  
		...
		function getTipoNome(){
			...
			elseif($this->tipo == 2) $ret = "Energia de Alta Tensão";
			elseif($this->tipo == 3) $ret = "Telefonia Celular";
			elseif($this->tipo == 4) $ret = "Telefonia Fixa";
			elseif($this->tipo == 5) $ret = "Banda Larga 3G";
			elseif($this->tipo == 6) $ret = "Rede Telemétrica";
			else $ret = "NDA";
			return $ret;
		...
		function getTipoMedida(){
			...
			elseif($this->tipo == 2) $ret = "KWh";
			elseif($this->tipo == 3) $ret = "Min";
			elseif($this->tipo == 4) $ret = "Min";
			elseif($this->tipo == 5) $ret = "Mb";
			elseif($this->tipo == 6) $ret = "Mb";
			else $ret = "NDA";
			return $ret;
		...
		/* PARA APAGARRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR	
